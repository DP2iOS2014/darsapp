...
#import "RutaBasuraViewController.h"

@interface RutaBasuraViewController ()

@property (nonatomic, strong) NSArray *items;

@end

@implementation RutaBasuraViewController
...
- (void)dealloc
{
    ...
    carruselruta.delegate = nil;
    carruselruta.dataSource = nil;
}
